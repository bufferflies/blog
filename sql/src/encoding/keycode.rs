...
//! f64:     Big-endian binary representation, with sign bit flipped, and rest
//! if negative. Vec<u8>: 0x00 is escaped as 0x00ff, terminated with 0x0000.
//! String:  Like Vec<u8>.
//!
...
impl<'a> ser::Serializer for &'a mut Serializer {
    ...
    /// Sequences are serialized as the concatenation of the serialized
    /// elements.
...
/// Sequences simply concatenate the serialized elements, with no external
/// structure.
